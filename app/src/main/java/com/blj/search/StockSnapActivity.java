...
public class StockSnapActivity extends AppCompatActivity {
    ...
    final String url="https://stocksnap.io/search/"+ encodedQuery;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_stocksnap);
