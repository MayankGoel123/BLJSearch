...
public class FreeImagesActivity extends AppCompatActivity {
    ...
    final String url="https://www.freeimages.com/search/"+ encodedQuery;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_freeimages);
